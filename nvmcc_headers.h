...
signed short fancoil_t_out_air[7];
signed short fancoil_t_room[7];
signed short fancoil_t_in_water[7];
signed short fancoil_speed[7];
signed short fancoil_mode[7];
signed short co2_commer;
signed short co2_work;
signed short empty;
struct TParams: TStdParams  {
    ...
    signed short fancoil_t_room_correct[7];
    signed short chill_on1[7];
    signed short chill_off1[7];
    signed short chill_on2[7];
    signed short chill_off2[7];
    signed short fancoil_speed_stp[7];
    signed short fancoil_t_stp[7];
    signed short fancoil_t_stp_hyst;
    signed short fancoil_t_pipe_hyst;
    signed short fancoil_t_in_water_heat;
    signed short fancoil_t_in_water_cool;
    signed short ex_fan_speed[3];
    signed short flaps;
};
TParams Params;
modbusdecl  {
...
modbusdecl  {
    ...
    unsigned char ;
    signed short ;
    fancoil_t_in_water_cool;
};
modbusdecl  {
    ModbusTable;
    unsigned char ;
    signed short ;
    fancoil_t_in_water_heat;
};
modbusdecl  {
    ModbusTable;
    unsigned char ;
